...
public class Maestria : MonoBehaviour {
    ...
    public void NewSoundtrack(string file = default) {
    ...
    public IEnumerator Transition(int transitionDuration) {
    ...
    public IEnumerator MuteTransition(int transitionDuration) {
